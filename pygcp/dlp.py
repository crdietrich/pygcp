...
class DLPBase:
    ...
    def get_info_types(self, language_code=None, result_filter=None):
        ...
        result_filter: XXX
            An optional filter to only return info types supported by certain 
    ...
    def info_type_description_flatten(itd):
        ...
        Parameters
        ----------
        itd : InfoTypeDescription
            Info type description class

        Returns
        -------
        name : str
            Name of DLP type identified

        display_name : str
            Display name of 
        description : str
            Description of the kind of information found
    ...
    def info_types_df(self, contains=None, 
                      language_code=None, result_filter=None):
        """TODO Placeholder

        Parameters
        ----------
        contains : str
            What the name or description should contain.
        language_code : str
            Language code to run search in. TODO: more detail.
        result_filter : TODO
        ...
        -------
        Pandas DataFrame
            Returned query info (TODO details)
            api_string : str
                foo
            display_name : str
                foo
            description : str
                Description of foo
            industry_category : str
                Industry that the item foo
            location_category : str
                What location it is associated with
            type_category : str
                The type of foo...
        """
        _it = self.get_info_types(language_code=language_code, 
                                  result_filter=result_filter)
        _df = pd.DataFrame([self.info_type_description_flatten(itd) for itd in _it],
                            columns=['api_string', 'display_name', 'description', 'industry_category',
                                     'location_category', 'type_category'])
    ...
    def custom_regex_builder(pattern_dict):
        ...
        pattern_dict : dict
            keys : str
                Name for custom regex pattern.
            values : str
                Regular expression for custom info type.
...
class DLPContent(DLPBase):
    ...
    def deidentify_with_replace(self, value, 
                                replacement=None,
                                info_types=None,
                                industry_category=None,
                                location_category=None,
        ...
        info_types = self.info_type_builder(info_types=info_types,
