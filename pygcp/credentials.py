...
def create_credentials(cred_file=None, project_id=None, scopes=None, verbose=False):
    ...
    * spreadsheets
    ...
    try:
        ...
        if verbose:
            print("Session environment authentication successful.")
    ...
    if verbose:
        print("Service Account JSON File authentication successful.")
...
def create_credentials2(cred_file=None, scopes=None, verbose=False):
    """Create Google credentials for use either locally with OAuth2 or
    locally within a GCP VM.
    ...
    * spreadsheets
    ...
    # VM or session with environmental variables
    try:
        gcp_credentials, _project_id = google.auth.default(scopes=scopes_list)
        if verbose:
            print("Session environment authentication successful.")
        return gcp_credentials
        ...
        if verbose:
            print("Unable to authenticate using JSON file or Environmental Variables.")
